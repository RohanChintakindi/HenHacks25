    ...
    <>
      <div className="text-center max-w-4xl mx-auto mb-16">
        ...
        <p className="subtitle text-xl text-gray-400 mb-12">
          Select the type of emergency and enter your contact details for immediate assistance
        </p>
      </div>

      <div className="max-w-2xl mx-auto mb-12">
        <div className="mb-6">
          <label htmlFor="phone" className="block text-gray-400 mb-2">Phone Number (required)</label>
          <div className="flex">
            ...
            <input
              ...
              className={`bg-gray-800 text-white tracking-widest px-4 py-3 rounded-r-md flex-1 focus:outline-none focus:ring-2 ${
                phoneError ? 'focus:ring-red-500 border border-red-500' : 'focus:ring-indigo-500'
              }`}
              maxLength={10}
            />
          </div>
          {phoneError && (
            <p className="text-red-500 mt-2">Phone number must be exactly 10 digits</p>
          )}
        </div>
      </div>
